import{c as t}from"./chunk-NRZ2XMVD.js";import{d as H,e as U}from"./chunk-LJINFNAP.js";import{M as w,U as A,X as O,l as f,m as E}from"./chunk-KXQZZRQB.js";var Q=O([[A.UP,0,1],[A.DOWN,0,2],[A.LEFT,0,4],[A.RIGHT,0,8],[A.A,0,16],[A.B,0,32],[A.P2_UP,1,1],[A.P2_DOWN,1,2],[A.P2_LEFT,1,4],[A.P2_RIGHT,1,8],[A.P2_A,1,16],[A.P2_B,1,32],[A.ANYKEY,2,0]]),e=0;var k=16,C=[A.VK_7,A.VK_6,A.VK_5,A.VK_4,A.VK_3,A.VK_2,A.VK_1,A.VK_0,A.VK_SEMICOLON,A.VK_CLOSE_BRACKET,A.VK_OPEN_BRACKET,A.VK_BACK_SLASH,A.VK_EQUALS,A.VK_MINUS,A.VK_9,A.VK_8,A.VK_B,A.VK_A,null,A.VK_SLASH,A.VK_PERIOD,A.VK_COMMA,A.VK_ACUTE,A.VK_QUOTE,A.VK_J,A.VK_I,A.VK_H,A.VK_G,A.VK_F,A.VK_E,A.VK_D,A.VK_C,A.VK_R,A.VK_Q,A.VK_P,A.VK_O,A.VK_N,A.VK_M,A.VK_L,A.VK_K,A.VK_Z,A.VK_Y,A.VK_X,A.VK_W,A.VK_V,A.VK_U,A.VK_T,A.VK_S,A.VK_F3,A.VK_F2,A.VK_F1,null,A.VK_CAPS_LOCK,null,A.VK_CONTROL,A.VK_SHIFT,A.VK_ENTER,null,A.VK_BACK_SPACE,null,A.VK_TAB,A.VK_ESCAPE,A.VK_F5,A.VK_F4,A.VK_RIGHT,A.VK_DOWN,A.VK_UP,A.VK_LEFT,A.VK_DELETE,A.VK_INSERT,A.VK_HOME,A.VK_SPACE,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null],i=class extends t{constructor(){super();this.numVisibleScanlines=240;this.defaultROMSize=32768;this.ram=new Uint8Array(65536);this.slotmask=0;this.ppi_c=0;this.read=s=>{let D=s>>14<<1,B=this.slotmask>>D&3,g=this.slots[B];return g?g.read(s):0};this.write=(s,D)=>{let B=s>>14<<1,g=this.slotmask>>B&3,T=this.slots[g];T&&T.write(s,D)};this.init(this,this.newIOBus(),new U(new H)),this.bios=new f().decode(E(atob(x))),this.bios[3541]=0,this.bios[3542]=0,this.bios[3543]=0,this.slots=[{read:s=>this.bios[s]|0,write:(s,D)=>{}},{read:s=>this.rom[s-16384]|0,write:(s,D)=>{}},{read:s=>this.rom[s-16384]|0,write:(s,D)=>{}},{read:s=>this.ram[s]|0,write:(s,D)=>{this.ram[s]=D}}]}loadBIOS(s){this.bios=s}getKeyboardMap(){return Q}getKeyboardFunction(){return(s,D,B,g)=>{for(var T=C,M=0;M<T.length;M++)if(T[M]&&T[M].c==D){let I=M>>3,R=7-(M&7);g&w.KeyDown?this.inputs[k+I]|=1<<R:g&w.KeyUp&&(this.inputs[k+I]&=~(1<<R));break}}}newIOBus(){return{read:s=>{switch(s&=255,s){case 152:return this.vdp.readData();case 153:return this.vdp.readStatus();case 162:return this.psg.currentRegister()==14?~this.inputs[e]:this.psg.readData();case 168:return this.slotmask;case 169:return~this.inputs[k+(this.ppi_c&15)];case 170:return this.ppi_c}return 0},write:(s,D)=>{switch(s&=255,D&=255,s){case 152:this.vdp.writeData(D);break;case 153:this.vdp.writeAddress(D);break;case 168:this.slotmask=D;break;case 170:this.ppi_c=D;break;case 171:let B=D>>1&7;this.ppi_c=this.ppi_c&~(1<<B)|(D&1)<<B;break;case 160:this.psg.selectRegister(D);break;case 161:this.psg.setData(D);break;case 252:case 253:case 254:case 255:break}}}}vdpInterrupt(){this.probe.logInterrupt(255),this.cpu.interrupt(255)}loadState(s){super.loadState(s),this.slotmask=s.slotmask,this.ppi_c=s.ppi_c,this.psg.selectRegister(s.psgRegister)}saveState(){var s=super.saveState();return s.slotmask=this.slotmask,s.ppi_c=this.ppi_c,s.psgRegister=this.psg.currentRegister(),s}reset(){super.reset(),this.slotmask=0,this.ppi_c=0}resetInputs(){this.inputs.fill(0)}},x=`
...
`;export{i as a};
//# sourceMappingURL=chunk-D5GXI4TI.js.map

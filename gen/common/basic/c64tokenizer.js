...
exports.C64BasicTokenizer = void 0;
const compiler_1 = require("./compiler");
class C64BasicTokenizer {
    constructor() {
    ...
    compile(source) {
        ...
        const program = {
            lines: [],
            startAddr: compiler_1.C64_BASIC_START_ADDR
        };
...
exports.C64BasicTokenizer = C64BasicTokenizer;
//# sourceMappingURL=c64tokenizer.js.map
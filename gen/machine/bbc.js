...
exports.BBCMicroMachine = void 0;
    ...
    window.bbc_debug = {
        ...
        openIframeWithCurrentProgram: () => {
            ...
            if (output && output instanceof Uint8Array) {
                const url = window.bbc_debug.generateIframeURL(output);
...
exports.BBCMicroMachine = BBCMicroMachine;

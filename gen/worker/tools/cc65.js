...
function assembleCA65(step) {
    ...
    (0, wasmutils_1.loadNative)(moduleName);
    ...
    var CA65_VERSION = wasmutils_1.emglobal.ca65({
    ...
    (0, wasmutils_1.setupFS)(FS_VERSION, '65-' + (0, util_1.getRootBasePlatform)(step.platform));
    ...
    (0, wasmutils_1.execMain)(versionStep, CA65_VERSION, ['--version']);
    ...
    if ((0, builder_1.staleFiles)(step, [objpath, lstpath])) {
        ...
        var moduleFunc = wasmutils_1.emglobal[moduleName];
        if (!moduleFunc) {
            console.log("BBC-specific module not available, falling back to standard ca65");
            moduleName = 'ca65';
            moduleFunc = wasmutils_1.emglobal.ca65;
        }
        var CA65 = moduleFunc({
            instantiateWasm: (0, wasmutils_1.moduleInstFn)(moduleName),
            noInitialRun: true,
            //logReadFiles:true,
        ...
        var fsName = workertools_1.TOOL_PRELOADFS['ca65-' + (0, util_1.getRootBasePlatform)(step.platform)];
        if (!fsName) {
            fsName = workertools_1.TOOL_PRELOADFS['65-' + (0, util_1.getRootBasePlatform)(step.platform)];
        }
        if (!fsName) {
            fsName = '65-' + (0, util_1.getRootBasePlatform)(step.platform); // fallback
        }
        (0, wasmutils_1.setupFS)(FS, fsName);
        (0, builder_1.populateFiles)(step, FS);
        (0, builder_1.populateExtraFiles)(step, FS, step.params.extra_compile_files);
...
function linkLD65(step) {
    ...
    if ((0, builder_1.staleFiles)(step, [binpath])) {
        ...
        if (!moduleFunc) {
            ...
            moduleName = 'ld65';
            moduleFunc = wasmutils_1.emglobal.ld65;
        }
        var LD65 = moduleFunc({
            instantiateWasm: (0, wasmutils_1.moduleInstFn)(moduleName),
            noInitialRun: true,
        ...
        var FS = LD65.FS;
        // Use TOOL_PRELOADFS mapping to determine filesystem
        var fsName = workertools_1.TOOL_PRELOADFS['ld65-' + (0, util_1.getRootBasePlatform)(step.platform)];
        if (!fsName) {
            fsName = workertools_1.TOOL_PRELOADFS['65-' + (0, util_1.getRootBasePlatform)(step.platform)];
        }
        if (!fsName) {
...
function compileCC65(step) {
    ...
    // Use BBC-specific WASM modules for BBC platform
    var moduleName = step.platform === 'bbc' ? 'cc65-bbc' : 'cc65';
    console.log("Using module:", moduleName, "Available modules:", Object.keys(wasmutils_1.emglobal));
    console.log("emglobal contents:", wasmutils_1.emglobal);
    // Try to use the specific module, fallback to standard if not available
    var moduleFunc = wasmutils_1.emglobal[moduleName];
    ...
    if (!moduleFunc) {
        ...
        moduleName = 'cc65';
        moduleFunc = wasmutils_1.emglobal.cc65;
    ...
    (0, wasmutils_1.execMain)(versionStep, CC65_VERSION, ['--version']);
    ...
    if ((0, builder_1.staleFiles)(step, [destpath])) {
        ...
        var FS = CC65.FS;
        // Use TOOL_PRELOADFS mapping to determine filesystem
        var fsName = workertools_1.TOOL_PRELOADFS['cc65-' + (0, util_1.getRootBasePlatform)(step.platform)];
        if (!fsName) {
            fsName = workertools_1.TOOL_PRELOADFS['65-' + (0, util_1.getRootBasePlatform)(step.platform)];
        }
        if (!fsName) {

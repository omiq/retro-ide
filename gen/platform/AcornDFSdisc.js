...
class AcornDFSdisc {
    constructor() {
        ...
        this.image.write(0x0000, "RETRO"); // DFS volume title (8 chars)
        this.image.write(0x0100, "IDE\0");
...
exports.AcornDFSdisc = AcornDFSdisc;
//# sourceMappingURL=AcornDFSdisc.js.map
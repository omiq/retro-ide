...
class MSXShellPlatform extends baseplatform_1.BaseZ80MachinePlatform {
    ...
    setupInputHandling(input, terminal) {
        const addOutput = (text, color) => {
...
_PCMREC::
    ...
    handleMSXBIOSCall(addr, addOutput) {
        const state = this.machine.cpu.saveState();
        switch (addr) {
...
emu_1.PLATFORMS['msx-shell'] = MSXShellPlatform;
//# sourceMappingURL=msx-shell.js.map
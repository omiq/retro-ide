...
class C64ChipsPlatform {
    constructor(mainElement) {
        this.running = false;
        this.pauseResumeSupported = false;
        this.mainElement = mainElement;
        this.machine = new c64_1.C64ChipsMachine();
    }
    async start() {
    ...
    setupIframeMessageListener() {
        window.addEventListener('message', (event) => {
            ...
            const iframe = document.getElementById("c64-iframe");
    ...
    reset() {
        ...
        const frame = document.getElementById("c64-iframe");
    ...
    loadROM(title, rom) {
        ...
        var frame = document.getElementById("c64-iframe");
        if (frame && frame.contentWindow) {
    ...
    async loadIframeWithProgram(iframeURL) {
...
emu_1.PLATFORMS['c64'] = C64ChipsPlatform;
// Export the platform class for dynamic loading
exports.default = C64ChipsPlatform;

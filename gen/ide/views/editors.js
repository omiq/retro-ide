...
const MODEDEFS = {
    ...
    gas: { isAsm: true },
    vasm: { isAsm: true },
    nasm: { isAsm: true }, // NASM (Netwide Assembler) syntax highlighting
    inform6: { theme: 'cobalt' },
    markdown: { lineWrap: true },
    fastbasic: { noGutters: true },
    basic: { noLineNumbers: true, noGutters: true }, // TODO: not used?
    qbasic: { noLineNumbers: true, noGutters: true }, // QBASIC syntax highlighting
    pascal: { theme: 'mbo' }, // Pascal/Turbo Pascal syntax highlighting

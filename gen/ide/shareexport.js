...
function _downloadROMImage(e) {
    console.log("_downloadROMImage called, platform:", ui_1.platform_id);
    console.log("getCurrentOutput():", (0, ui_1.getCurrentOutput)());
    console.log("platform.getDownloadFile exists:", !!ui_1.platform.getDownloadFile);
    if ((0, ui_1.getCurrentOutput)() == null) {
    ...
    if (ui_1.platform.getDownloadFile) {
        ...
        if (dl) {
            ...
            (0, dialogs_1.alertError)("No downloadable file available. Make sure you have compiled a program.");
        }
    }

10 REM BBC Super Star Trek thanks to Electron Greg:
20 REM ---> https://electrongreg.itch.io/trek-beeb
30 REM ============================================
70 CLEAR
90 GOSUB 6500
200 X9=RND(-TIME)
...
280 REM INITIALISE ENTERPRISE'S POSITION
...
350 REM CREATE GALAXY
360 REM K3=KLINGONS  B3=STARBASES  S3=STARS
370 FOR I=1 TO 8:PRINT ".";:FOR J=1 TO 8:K3=0:Z(I,J)=0:R1=RND(1)
380 IF R1>.98 K3=3:K9=K9+3:GOTO 410
390 IF R1>.95 K3=2:K9=K9+2:GOTO 410
400 IF R1>.80 K3=1:K9=K9+1
410 B3=0:IF RND(1)>.96 B3=1:B9=B9+1
420 G(I,J)=K3*100+B3*10+FNR(1):NEXT J:NEXT I:IF K9>T9 T9=K9+1
430 PRINT" DONE!"
440 GOSUB 6080
450 GOSUB 6150
460 PRINT:GOSUB 6020
470 IF B9<>0 GOTO 500
480 IF G(Q1,Q2)<200 G(Q1,Q2)=G(Q1,Q2)+120:K9=K9+1
490 B9=1:G(Q1,Q2)=G(Q1,Q2)+10:Q1=FNR(1):Q2=FNR(1)
500 K7=K9:IF B9<>1 X$="S":X0$=" ARE "
...
590 IF Q1<1 OR Q1>8 OR Q2<1 OR Q2>8 GOTO 700
600 GOSUB 5610:PRINT:IF T0<>T GOTO 650
610 PRINT"YOUR MISSION BEGINS WITH YOUR STARSHIP"
620 PRINT"IN THE QUADRANT, '";G2$;"'.":quadname$=G2$
630 SRSFLAG=1
640 GOTO 670
650 IF ATAKFLAG=1 GOSUB 6020:ATAKFLAG=0:PRINT
...
690 I=1
695 K(I,1)=0:K(I,2)=0:I=I+1:IF I>3 GOTO 700 ELSE GOTO 695
700 I=1
705 K(I,3)=0:I=I+1:IF I>3 GOTO 706 ELSE GOTO 705
706 Q$=Z$+Z$+Z$+Z$+Z$+Z$+Z$+LEFT$(Z$,17)
710 REM POSITION ENTERPRISE, KLINGONS, STARBASES, & STARS
730 A$=FCOL$+"E"+BCOL$:Z1=S1:Z2=S2:GOSUB 5400:IF K3<1 GOTO 760
740 I%=1
745 GOSUB 5370:A$=ECOL$+"K"+BCOL$:Z1=R1:Z2=R2
750 GOSUB 5400:K(I%,1)=R1:K(I%,2)=R2:K(I%,3)=S9*(0.5+RND(1)):I%=I%+1:IF I%>K3 GOTO 760 ELSE GOTO 745
760 IF B3<1 GOTO 780
...
790 GOSUB 3580
800 IF S+E>10 IF E>10 OR D(7)=0 GOTO 890
...
905 IF A$="SLS" SLSFLAG=1
906 IF A$="SLS" PRINT:PRINT "SHORT & LONG RANGE SCAN...":GOTO 3570
910 IF A$<>"KEY" GOTO 940
920 GOSUB 6080:REM KEY TO SRS ICONS
930 GOTO 890
940 COMFLAG=0:IF A$="GAL" AND D(8)>=0 A$="COM":COMFLAG=1
945 IF D(8)<0 AND A$="GAL" PRINT:PRINT "SHIP'S COMPUTER DISABLED":GOTO 890
950 I=1
955 IF LEFT$(A$,3)<>MID$(A1$,3*I-2,3) GOTO 970
960 ON I GOTO 1000,790,1850,2110,2380,2820,2950,4140,3420
970 I=I+1:IF I>9 GOTO 975 ELSE GOTO 955
975 GOSUB 6150
980 GOTO 800
990 REM COURSE CONTROL
1000 GOSUB 6290
1010 PRINT:LX=5:PRINT"COURSE (1-9): ";:GOSUB 5860
1020 C1=VAL(LII$):IF C1=9 C1=1
1030 IF C1>=1 AND C1<9 GOTO 1060
1040 PRINT:PRINT"LT. SULU REPORTS, 'INCORRECT COURSE"
1050 PRINT"DATA, SIR!'":GOTO 800
1060 X$="8":IF D(1)<0 X$="0.2"
1070 SRSFLAG=1:LX=5:PRINT"WARP FACTOR (0-";X$;"): ";:GOSUB 5860
1080 W1=VAL(LII$):IF D(1)<0 AND W1>.2 GOTO 1130
1090 IF W1>0 AND W1<=8 GOTO 1150
1100 IF W1=0 GOTO 800
...
1240 I=1
1245 IF K(I,3)=0 GOTO 1270
1250 A$="   ":Z1=K(I,1):Z2=K(I,2):GOSUB 5400:GOSUB 5370
1260 K(I,1)=Z1:K(I,2)=Z2:A$=ECOL$+"K"+BCOL$:GOSUB 5400
1270 I=I+1:IF I>K3 GOTO 1275 ELSE GOTO 1245
1275 GOSUB 3210:D1=0:D6=W1:IF W1>=1 D6=1
1280 I=1
1285 IF D(I)>=0 GOTO 1330
1290 D(I)=D(I)+D6:IF D(I)>-.1 AND D(I)<0 D(I)=-.1:GOTO1330
1300 IF D(I)<0 GOTO 1330
1310 IF D1<>1 D1=1:PRINT:PRINT"DAMAGE CONTROL REPORT:  "
1320 R1=I:GOSUB 5460:PRINTG2$;" REPAIR COMPLETED"
1330 I=I+1:IF I>8 GOTO 1340 ELSE GOTO 1285
1340 IF RND(1)>.2 GOTO 1410
1350 R1=FNR(1):IF RND(1)>=.6 GOTO 1380
...
1440 I=1
1445 S1=S1+X1:S2=S2+X2:IF S1<1 OR S1>=9 OR S2<1 OR S2>=9 GOTO 1580
...
1490 SRSFLAG=1
1500 GOTO 1520
1510 I=I+1:IF I>N GOTO 1515 ELSE GOTO 1445
1515 S1=INT(S1):S2=INT(S2)
1520 A$=FCOL$+"E"+BCOL$:Z1=INT(S1):Z2=INT(S2):GOSUB 5400:GOSUB 1790:T8=1
1530 IF W1<1 T8=.1*INT(10*W1)
1540 T=T+T8:IF T>T0+T9 GOTO 3370
1550 REM SEE IF DOCKED
1560 GOTO 790
1570 REM EXCEED LIMITS
1580 X=8*Q1+X+N*X1:Y=8*Q2+Y+N*X2:Q1=INT(X/8):Q2=INT(Y/8):S1=INT(X-Q1*8)
1590 S2=INT(Y-Q2*8):IF S1=0 Q1=Q1-1:S1=8
1600 IF S2=0 Q2=Q2-1:S2=8
1610 X5=0:IF Q1<1 X5=1:Q1=1:S1=1
1620 IF Q1>8 X5=1:Q1=8:S1=8
1630 IF Q2<1 X5=1:Q2=1:S2=1
1640 IF Q2>8 X5=1:Q2=8:S2=8
1650 IF X5=0 GOTO 1760
...
1750 IF T>T0+T9 GOTO 3370
1760 IF 8*Q1+Q2=8*Q4+Q5 GOTO 1520
1770 T=T+1:GOSUB 1790:GOTO 580
1780 REM MANOEUVRE ENERGY
1790 E=E-N-10:IF E>=0 RETURN
1800 PRINT:PRINT"SHIELD CONTROL SUPPLIES ENERGY TO"
1810 PRINT"COMPLETE THE MANOEUVRE."
1820 S=S+E:E=0:IF S<=0 S=0
1830 RETURN
1840 REM LONG RANGE SCAN
1850 K1=0
1860 IF D(3)<0 PRINT:PRINT"LONG RANGE SENSORS ARE INOPERABLE"
1865 IF D(3)<0 SLSFLAG=0:GOTO800
...
1904 J=Q2-1:JJ=Q2+1
1910 IF I>0 AND I<9 AND J>0 AND J<9 N(J-Q2+2)=G(I,J):Z(I,J)=G(I,J)
1920 J=J+1:IF J>JJ GOTO 1925 ELSE GOTO 1910
1925 L=1
1930 REM IF K1=2 AND L=3 PRINT CHR$(146);"";
1940 PRINT BCOL$;":";
1950 IF K1=2 AND L=2 PRINT FCOL$;:GOTO 1970
1960 PRINT " ";
1970 IF N(L)<0 PRINT"***";:GOTO 2000
1980 G1$=RIGHT$(STR$(N(L)+1000),3)
1990 G2$=MID$(G1$,1,3):PRINT G2$;
2000 L=L+1:IF L>3 GOTO 2005 ELSE GOTO 1930
2005 PRINT" :";:K1=K1+1
2010 IF K1=1 PRINT "        . . ."
2020 IF K1=3 PRINT "      .   .   ."
2030 IF K1=5 PRINT "    .           ."
...
2050 IF K1=2 PRINT "       .  .  ."
2060 IF K1=4 PRINT "     .  BASES";
2070 IF K1=4 PRINT "  ."
2080 IF K1=6 PRINT "  KLINGONS    STARS"
2090 I=I+1:IF I>II GOTO 2093 ELSE GOTO 1902
2093 K1=0:IF SLSFLAG=1 SLSFLAG=0
2095 GOTO 890
2100 REM PHASER CONTROL
2110 IF D(4)<0 PRINT:PRINT"PHASERS INOPERATIVE":GOTO 800
2120 IF K3>0 GOTO 2150
2130 PRINT:PRINT"SCIENCE OFFICER SPOCK REPORTS 'SENSORS"
2140 PRINT"SHOW NO ENEMY SHIPS IN THIS QUADRANT'":GOTO 800
2150 IF D(8)<0 PRINT:PRINT"COMPUTER FAILURE HAMPERS ACCURACY"
...
2190 X=VAL(LII$):IF X<=0 GOTO 800
2200 IF E-X<0 GOTO 2170
2210 E=E-X:IF D(7)<0 X=X*RND(1)
2220 H1=INT(X/K3):I=1
2225 IF K(I,3)<=0 GOTO 2340
2230 H=INT((H1/FND(0))*(RND(1)+2)):IF H>.15*K(I,3) GOTO 2270
...
2290 IF K(I,3)<=0 PRINT" *** KLINGON DESTROYED ***":GOTO 2320
2300 PRINT" (SENSORS SHOW ";INT(K(I,3));" UNITS REMAINING)"
2310 GOTO 2340
2320 K3=K3-1:K9=K9-1:Z1=K(I,1):Z2=K(I,2):A$="   ":GOSUB 5400
2330 K(I,3)=0:G(Q1,Q2)=G(Q1,Q2)-100:Z(Q1,Q2)=G(Q1,Q2):IF K9<=0 GOTO 3510
2340 I=I+1:IF I>3 GOTO 2350 ELSE GOTO 2225
2350 IF K3>0 PRINT:GOSUB 6020
2360 GOSUB 3210:GOTO 800
2370 REM PHOTON TORPEDO
2380 IF P<=0 PRINT:PRINT"ALL PHOTON TORPEDOES EXPENDED":GOTO 800
2390 IF D(5)<0 PRINT:PRINT"PHOTON TUBES ARE NOT OPERATIONAL":GOTO 800
2400 GOSUB 6290:REM * DIRECTION HELPER *
2410 PRINT:LX=5:PRINT "PHOTON TORPEDO COURSE (1-9): ";:GOSUB 5860
2420 C1=VAL(LII$):IF C1=9 C1=1
2430 IF C1>=1 AND C1<9 GOTO 2470
...
2510 IF X3<1 OR X3>8 OR Y3<1 OR Y3>8 GOTO 2780
2520 PRINT" ";X3;",";Y3:A$="   ":Z1=X:Z2=Y:GOSUB 5560
2530 IF Z3<>0 GOTO 2500
2540 A$=ECOL$+"K"+BCOL$:Z1=X:Z2=Y:GOSUB 5560:IF Z3=0 GOTO 2610
2550 PRINT" *** KLINGON DESTROYED ***"
2560 K3=K3-1:IF K3>0 PRINT:GOSUB 6020
2570 K9=K9-1:IF K9<=0 GOTO 3510
2580 I=1
2585 IF X3=K(I,1) AND Y3=K(I,2) GOTO 2600
2590 I=I+1:IF I>3 GOTO 2595 ELSE GOTO 2585
2595 I=3
2600 K(I,3)=0:GOTO 2760
2610 A$=HCOL$+"*"+BCOL$:Z1=X:Z2=Y:GOSUB 5560:IF Z3=0 GOTO 2650
2620 PRINT" ** STAR AT ";X3;",";Y3;" ABSORBED TORPEDO **"
2630 IF K3<>0 PRINT:GOSUB 6020
2640 GOSUB 3210:GOTO 800
2650 A$=DCOL$+"B"+BCOL$:Z1=X:Z2=Y:GOSUB 5560:IF Z3=0 GOTO 2400
2660 PRINT" *** STARBASE DESTROYED ***"
2670 PRINT:GOSUB 6020
2680 B3=B3-1:B9=B9-1
2690 IF B9>0 OR K9>T-T0-T9 GOTO 2740
...
2850 X=VAL(LII$)
2860 IF X<0 OR S=X PRINT"<SHIELDS UNCHANGED>":GOTO 800
2870 IF X<=E+S GOTO 2910
...
2950 IF D(6)>=0 GOTO 3100
2960 PRINT:PRINT"DAMAGE CONTROL REPORT NOT AVAILABLE"
2970 IF D0=0 GOTO 800
2980 D3=0:FOR I=1 TO 8:IF D(I)<0 D3=D3+.1
2990 NEXT I:IF D3=0 GOTO 800
3000 D3=D3+D4:IF D3>=1 D3=.9
...
3150 IF D2<0 PRINT CCOL$;"DAMAGED     ";D2;BCOL$
3160 IF D2>0 PRINT " OPERATIONAL ";D2
3170 IF D2=0 PRINT " OPERATIONAL ";D2
3180 NEXT R1:IF D0<>0 GOTO 2980
3190 GOTO 800
3200 REM KLINGONS SHOOTING
3210 IF K3<=0 RETURN
3220 IF D0<>0 PRINT:PRINT"STARBASE SHIELDS PROTECT THE ENTERPRISE"
3230 IF D0<>0 RETURN
3240 I=1
3245 IF K(I,3)<=0 GOTO 3330
3250 H=INT((K(I,3)/FND(1))*(2+RND(1))):S=S-H:K(I,3)=K(I,3)/(3+RND(0))
3260 PRINT:PRINT " ";H;" UNIT HIT ENTERPRISE FROM ";K(I,1);",";K(I,2)
3270 IF S<=0 GOTO 3380
3280 PRINT" <SHIELDS DOWN TO ";S;" UNITS>":IF H<20 GOTO 3330
3290 IF RND(1)>.6 OR H/S<=.02 GOTO 3330
3300 R1=FNR(1):D(R1)=D(R1)-H/S-.5*RND(1):GOSUB 5460
3310 PRINT:PRINT"DAMAGE CONTROL REPORTS: "
3320 PRINT G2$;" DAMAGED BY THE HIT"
3330 I=I+1:IF I>3 GOTO 3340 ELSE GOTO 3245
3340 ATAKFLAG=1
3350 RETURN
...
3580 IF ATAKFLAG=1 PRINT:GOSUB 6020:ATAKFLAG=0
3590 IF D(2)<0 GOTO 3720
3610 IF SRSFLAG=0 PRINT:PRINT"SHORT RANGE SCAN + SUMMARY DATA"
3620 SRSFLAG=0:ATAKFLAG=0
3630 II=S1-1:II2=S1+1
3632 JJ=S2-1:JJ2=S2+1
3640 IF INT(II+.5)<1 OR INT(II+.5)>8 OR INT(JJ+.5)<1 OR INT(JJ+.5)>8 GOTO 3660
3650 A$=DCOL$+"B"+BCOL$:Z1=II:Z2=JJ:GOSUB 5560:IF Z3=1 GOTO 3670
3660 JJ=JJ+1:IF JJ>JJ2 GOTO 3662 ELSE GOTO 3640
3662 II=II+1:IF II>II2 GOTO 3665 ELSE GOTO 3632
3665 D0=0:IF Z3=1 GOTO 3670 ELSE GOTO 3690
3670 D0=1:C$=DCOL$+"DOCKED"+BCOL$:E=E0:P=P0
3680 PRINT:PRINT"SHIELDS DROPPED FOR DOCKING PURPOSES":S=0:GOTO3710
3690 IF K3>0 C$=CCOL$+"*RED*"+BCOL$:GOTO 3710
3700 C$=FCOL$+"GREEN"+BCOL$:IF E<E0*.1 C$=HCOL$+"AMBER"+BCOL$
3710 IF D(2)>=0 GOTO 3730
3720 PRINT:PRINT"*** SHORT RANGE SENSORS ARE OUT ***"
3722 IF SLSFLAG=1 GOTO 1840
3725 RETURN
3730 IF K3=0 GOTO 3760
...
3860 J=J1
3870 Z3$=MID$(Q$,J,2)
3875 IF J=J1 AND Z3$<>"  " THEN PRINT CHR$(127);
3877 IF J=J1 AND Z3$="  " THEN PRINT " ";:GOTO 3930
3920 PRINT Z3$;
3930 IF J=J2 AND Z3$="  " PRINT CHR$(127);BCOL$;":"; ELSE IF J=J2 PRINT BCOL$;
3940 IF J<>J2 PRINT "";
3950 J=J+3:IF J>J2 GOTO 3960 ELSE GOTO 3870
3960 IF I=1 PRINT" DAYS LEFT ";.1*INT((T0+T9-T)*10);
3970 IF I=2 PRINT" CONDITION";
3980 IF I=2 PRINT C$;
3990 IF I=3 PRINT" QUADRANT  ";Q1;",";Q2;
4000 IF I=4 PRINT" SECTOR    ";S1;",";S2;
4010 IF I=5 PRINT" TORPEDOES ";INT(P);
4020 IF I=6 PRINT" ENERGY    ";INT(E+S);
4030 IF I=7 PRINT" SHIELDS   ";INT(S);
4040 IF I=7 AND S<201 AND K3>0 PRINT LOW$;
4050 IF I=8 PRINT" KLINGONS  ";INT(K9);
4060 PRINT
4070 I=I+1:IF I>8 GOTO 4075 ELSE GOTO 3830
4075 PRINT "  +-+-+-+-+-+-+-+-+";
4080 MW=E/8:MW=MW*10:MW=INT(MW):MW=MW/10
4090 IF MW>8 MW=8
4100 IF D(1)<0 AND MW>0.2 MW=0.2
4110 PRINT" MAX WARP  ";MW
4115 IF SLSFLAG=1 GOTO 1840
4120 RETURN
4130 REM LIBRARY COMPUTER CODE
4140 IF D(8)<0 PRINT:PRINT"COMPUTER DISABLED":GOTO800
...
4230 IF COMFLAG=1 PRINT "0":A=0:A1=0:GOTO 4270
4240 GOSUB 5860
4250 A=VAL(LII$):A1=A:IF A<0 OR A>5 GOTO 890
4260 IF LII$="" GOTO 890
...
4350 IF A1=5 GOSUB 6390:GOTO 4380
4360 PRINT " ";J$;"  ";
4380 J=J+1:IF J>8 GOTO 4390 ELSE GOTO 4345
4390 PRINT
4400 O1$="  +---+---+---+---+---+---+---+---+"
4410 PRINTO1$:I=1
4415 I$=STR$(I):I$=RIGHT$(I$,1)
4420 IF I=Q1 PRINT " ";I$;
4430 IF A1=5 AND I=Q1 GOTO 4540
4440 IF I<>Q1 PRINT" ";I$;:IF H8=0 GOTO 4540
4450 J=1
4460 IF I=Q1 AND J=Q2 PRINT FCOL$;:GALFLAG=1:GOTO 4490
4470 IF I=Q1 AND J-1=Q2 GOTO 4490
4480 IF I<>Q1 OR J<>Q2 PRINT":";
4490 IF Z(I,J)=0 PRINT"   ";:GOTO 4530
4500 G1$=RIGHT$(STR$(Z(I,J)+1000),3)
4502 G2$=MID$(G1$,1,3):PRINT G2$;
4520 IF GALFLAG=1 PRINT BCOL$;:GALFLAG=0
4530 J=J+1:IF J>8 GOTO 4535 ELSE GOTO 4460
4535 GOTO 4620
4540 Z4=I:Z5=1:GOSUB 5610:J0=INT(11-.5*LEN(G2$))
4550 PRINT":";
4560 IF I=Q1 AND Q2<5 PRINT FCOL$;TAB(J0);G2$;BCOL$;:GOTO 4580
4570 PRINTTAB(J0);G2$;
4580 PRINTTAB(18);":";
4590 Z5=5:GOSUB 5610:J0=INT(27-.5*LEN(G2$))
4600 IF I=Q1 AND Q2>4 PRINT FCOL$;TAB(J0);G2$;BCOL$;:GOTO 4615
4610 PRINTTAB(J0);G2$;
4615 PRINTTAB(34);":";
4620 IF A=0 AND J=9 AND Q1=I AND Q2=8 PRINT:GOTO 4640
4630 IF A=0 PRINT":"
4640 IF A=5 PRINT
4650 PRINTO1$:I=I+1:IF I>8 GOTO 4655 ELSE GOTO 4415
4655 A1=0:GOTO 800
4660 REM STATUS
4670 PRINT:PRINT "STATUS REPORT:":X$="":IF K9>1 X$="S"
...
4730 X$="S":IF B9<2 X$="":IF B9<1 GOTO 4770
...
4920 C1=VAL(LII$):IF C1=0 PRINT:PRINT"CALCULATION ABORTED!":GOTO 890
4930 LX=4:PRINT"ENTER INITIAL COORDINATES (X): ";:GOSUB 5860
4940 A=VAL(LII$):IF A=0 PRINT:PRINT"CALCULATION ABORTED!":GOTO 890
4950 PRINT:LX=4:PRINT"ENTER FINAL COORDINATES   (Y): ";:GOSUB 5860
4960 W1=VAL(LII$):IF W1=0 PRINT:PRINT"CALCULATION ABORTED!":GOTO 890
4970 LX=4:PRINT"ENTER FINAL COORDINATES   (X): ";:GOSUB 5860
4980 X=VAL(LII$):IF X=0 PRINT:PRINT"CALCULATION ABORTED!":GOTO 890
4990 IF C1=W1 AND A=X PRINT:PRINT"NO RESULTS POSSIBLE!":GOTO 890
5000 X=X-A:A=C1-W1:IF X<0 GOTO 5140
5010 IF A<0 GOTO 5160
5020 IF X>0 GOTO 5040
5030 IF A=0 C1=5:GOTO 5050
5040 C1=1
...
5260 PRINT" DISTANCE  = ";
5270 D2=SQR(X^2+A^2)
5280 IF A1=3 OR A1=2 D2=D2/10
5290 D2=D2*1000:D2=D2+0.5:D2=INT(D2):D2=D2/1000
5300 PRINT "";D2
5310 IF H8=1 GOTO 800
5320 NEXT I:GOTO 800
5330 IF B3<>0 PRINT:PRINT"FROM ENTERPRISE TO STARBASE":W1=B4:X=B5:GOTO 4870
...
5370 A$="   "
5375 R1=FNR(1):R2=FNR(1):Z1=R1:Z2=R2:GOSUB 5560:IF Z3=0 GOTO 5370
5380 RETURN
5390 REM ARRAY FOR QUADRANT
5400 S8=INT(Z2-.5)*3+INT(Z1-.5)*24+1
5410 IF LEN(A$)<>3 PRINT"ERROR":STOP
5420 IF S8 =1 Q$=A$+RIGHT$(Q$,189):RETURN
5430 IF S8 =190 Q$=LEFT$(Q$,189)+A$:RETURN
...
5570 IF MID$(Q$,S8,3)<>A$ RETURN
5580 Z3=1:RETURN
5590 REM QUADRANT NAME IN G2$ FROM Z4,Z5 (=Q1,Q2)
5610 IF Z5<=4 ON Z4 GOTO 5630,5640,5650,5660,5670,5680,5690,5700
5620 GOTO 5710
...
5790 G2$="SPICA"
5800 IF G5<>1 ON Z5 GOTO 5820,5830,5840,5850,5820,5830,5840,5850
5810 RETURN
5820 G2$=G2$+" I":RETURN
...
6040 CR$="PRESS RETURN TO CONTINUE "
...
6197 PRINT" GAL - NAVIGATED GALAXY (VIA COMPUTER)"
...
6410 IF J=1 OR J=5 PRINT " I ";;
6420 IF J=2 OR J=6 PRINT "II ";
6430 IF J=3 OR J=7 PRINT "III";
6440 IF J=4 OR J=8 PRINT "IV ";
6450 PRINT " ";:RETURN
6500 REM * INITIALISATION & COLOURS
6520 BCOL$=CHR$(135):REM WHITE
6530 CCOL$=CHR$(129):REM RED
6540 DCOL$=CHR$(134):REM CYAN
6550 ECOL$=CHR$(133):REM VIOLET
6560 FCOL$=CHR$(130):REM GREEN
6580 HCOL$=CHR$(131):REM YELLOW
6590 ICOL$=CHR$(132):REM BLUE
6660 MODE 7
...
20005 ii$="":x%=LX
20010 i$=INKEY$(0)
20020 IF i$="" GOTO 20010
20030 IF ASC(i$)=127 GOTO 20055
20035 IF ASC(i$)=13 AND x%=0 PRINT"...":LII$=ii$:RETURN
20040 IF ASC(i$)=13 PRINT::LII$=ii$:RETURN
20045 IF ASC(i$)=32 GOTO 20070
20050 IF ASC(i$)<46 OR ASC(i$)>90 GOTO 20010
20055 IF ASC(i$)=127 AND LEN(ii$)<1 GOTO 20010
20060 IF i$=CHR$(127) i$="":ii$=LEFT$(ii$,(LEN(ii$)-1)):PRINT CHR$(127);
20070 IF LEN(ii$)<x% PRINT i$;
20080 IF LEN(ii$)<x% ii$=ii$+i$
20090 GOTO 20010